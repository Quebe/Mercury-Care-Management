...
/*
IF EXISTS (SELECT name FROM sysobjects WHERE (name = 'PopulationProcess_ServiceEvents_AddAnchor4' AND type = 'P'))
  DROP PROCEDURE dbo.PopulationProcess_ServiceEvents_AddAnchor4
GO      
*/

CREATE PROCEDURE dbo.PopulationProcess_ServiceEvents_AddAnchor4
      ...
      /* STORED PROCEDURE (BEGIN) */
        ...
        INSERT INTO PopulationMembershipServiceEvent
          ...
          SELECT 
            ...
            FROM 
              PopulationProcess_ServiceEvents_AddAnchor4_SupportView AS SupportView
