...
/*
IF EXISTS (SELECT name FROM sysobjects WHERE (name = 'PopulationProcess_ServiceEvents_ComplianceAnchor2' AND type = 'P'))
  DROP PROCEDURE dbo.PopulationProcess_ServiceEvents_ComplianceAnchor2
GO      
*/

CREATE PROCEDURE dbo.PopulationProcess_ServiceEvents_ComplianceAnchor2
    ...
    BEGIN
      /* STORED PROCEDURE (BEGIN) */
        ...
        BEGIN TRANSACTION
          ...
          -- THIS PROCEDURE IS CALLED FOR ANCHORS 0, 1, AND 2, WHICH REQUIRE THAT ALL SERVICES 
          ...
          SELECT DISTINCT 
            ...
            FROM 
              ...
              PopulationMembership
                ...
                -- FOR ANCHOR DATE 2 (PREVIOUS SERVICE EVENT), NOT USED WITHIN SAME POPULATION SEGMENT
                LEFT JOIN PopulationMembershipServiceEvent AS UtilizedMemberServiceByPreviousServiceEvent
                  ON PopulationMembership.PopulationMembershipId = UtilizedMemberServiceByPreviousServiceEvent.PopulationMembershipId 
                    AND MemberService.MemberServiceId = UtilizedMemberServiceByPreviousServiceEvent.MemberServiceId
                    AND (PopulationServiceEvent.AnchorDate = 2)
            ...
            WHERE 
              ...
              AND (UtilizedMemberServiceByPreviousServiceEvent.MemberServiceId IS NULL)
...
/*
GRANT EXECUTE ON PopulationProcess_ServiceEvents_ComplianceAnchor2 TO PUBLIC
GO          
*/