            ...
            FROM 
              ...
              PopulationMembership
                ...
                JOIN MemberService
                  ...
                  AND MemberService.EventDate > PopulationMembership.EffectiveDate
                  
                -- NOT PREVIOUSLY USED TO MAKE SAME TYPE OF SERVICE EVENT (BY ID) COMPLIANT
                LEFT JOIN PopulationMembershipServiceEvent AS UtilizedMemberService
                  ON PopulationMembershipServiceEvent.PopulationServiceEventId = UtilizedMemberService.PopulationServiceEventId
...
/*
GRANT EXECUTE ON PopulationProcess_ServiceEvents_Compliance TO PUBLIC
GO          
*/