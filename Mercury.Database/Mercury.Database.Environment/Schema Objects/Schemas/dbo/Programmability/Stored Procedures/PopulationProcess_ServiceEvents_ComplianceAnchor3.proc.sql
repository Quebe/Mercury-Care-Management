...
/*
IF EXISTS (SELECT name FROM sysobjects WHERE (name = 'PopulationProcess_ServiceEvents_ComplianceAnchor3' AND type = 'P'))
  DROP PROCEDURE dbo.PopulationProcess_ServiceEvents_ComplianceAnchor3
GO      
*/

CREATE PROCEDURE dbo.PopulationProcess_ServiceEvents_ComplianceAnchor3
            ...
            FROM 
              ...
              PopulationMembership
                ...
                JOIN MemberService
                  ...
                  AND MemberService.EventDate >= DATEADD (YEAR, PopulationServiceEvent.AnchorDateValue, Member.BirthDate)
...
/*
GRANT EXECUTE ON PopulationProcess_ServiceEvents_ComplianceAnchor3 TO PUBLIC
GO          
*/