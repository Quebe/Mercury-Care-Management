-- DROP VIEW [dbo].[PopulationProcess_ServiceEvents_AddAnchor3_SupportView] 

CREATE VIEW [dbo].[PopulationProcess_ServiceEvents_AddAnchor3_SupportView] AS 
          ...
          SELECT 
              ...
              CASE 
                  WHEN (PopulationServiceEvent.ScheduleDateQualifier = 0) THEN DATEADD (DAY,   PopulationServiceEvent.ScheduleDateValue, DATEADD (YEAR, PopulationServiceEvent.AnchorDateValue, Member.BirthDate))
                  WHEN (PopulationServiceEvent.ScheduleDateQualifier = 2) THEN DATEADD (YEAR,  PopulationServiceEvent.ScheduleDateValue, DATEADD (YEAR, PopulationServiceEvent.AnchorDateValue, Member.BirthDate) )
                  ELSE DATEADD (MONTH, PopulationServiceEvent.ScheduleDateValue, DATEADD (YEAR, PopulationServiceEvent.AnchorDateValue, Member.BirthDate) )
