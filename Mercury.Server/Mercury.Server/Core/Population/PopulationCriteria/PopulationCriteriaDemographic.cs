...
namespace Mercury.Server.Core.Population.PopulationCriteria {
    ...
    [DataContract (Name = "PopulationCriteriaDemographic")]
    public class PopulationCriteriaDemographic : CoreObject {
        ...
        public PopulationCriteriaDemographic (Application applicationReference) { base.BaseConstructor (applicationReference); }

        public PopulationCriteriaDemographic (Application applicationReference, Int64 forId) { base.BaseConstructor (applicationReference, forId); }
        ...
        public override Boolean Save () {
            ...
            try {
                ...
                sqlStatement.Append ("EXEC dbo.PopulationCriteriaDemographic_InsertUpdate ");
