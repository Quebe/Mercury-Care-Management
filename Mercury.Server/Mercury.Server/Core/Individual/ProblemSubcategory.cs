...
namespace Mercury.Server.Core.Individual {
    ...
    [DataContract (Name = "ProblemSubcategory")]
    public class ProblemSubcategory : CoreConfigurationObject {

        #region Constructors

        public ProblemSubcategory (Application applicationReference) {
        ...
        public ProblemSubcategory (Application applicationReference, Int64 forId) {
        ...
        public override Boolean Load (Int64 forId) {
            ...
            selectStatement.Append ("SELECT * FROM dbo.ProblemSubcategory WHERE ProblemSubcategoryId = " + forId.ToString ());
        ...
        public override Boolean Save () {
            ...
            if (!application.HasEnvironmentPermission (Server.EnvironmentPermissions.ProblemStatementManage)) { throw new ApplicationException ("Permission Denied [ProblemSubcategory.Save]."); }
