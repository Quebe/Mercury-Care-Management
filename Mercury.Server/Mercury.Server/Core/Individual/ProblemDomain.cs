...
namespace Mercury.Server.Core.Individual {
    ...
    [DataContract (Name = "ProblemDomain")]
    public class ProblemDomain : CoreConfigurationObject {
        
        #region Constructors

        public ProblemDomain (Application applicationReference) {
        ...
        public ProblemDomain (Application applicationReference, Int64 forId) {
        ...
        public override Boolean Load (Int64 forId) {
            ...
            selectStatement.Append ("SELECT * FROM dbo.ProblemDomain WHERE ProblemDomainId = " + forId.ToString ());
        ...
        public override Boolean Save () {
            ...
            if (!application.HasEnvironmentPermission (Server.EnvironmentPermissions.ProblemStatementManage)) { throw new ApplicationException ("Permission Denied [ProblemDomain.Save]."); }
            ...
            try {
                ...
                sqlStatement.Append ("EXEC dbo.ProblemDomain_InsertUpdate ");
