...
namespace Mercury.Client.ValueConverters {
    ...
    public class DateToAgeInYearsMonthsString : System.Windows.Data.IValueConverter {
        ...
        public Object Convert (Object value, Type targetType, object parameter, System.Globalization.CultureInfo culture) {
            ...
            if ((value != null) && (value is DateTime)) {
                ...
                convertedValue = currentAge.ToString () + "y";


                if (currentAge < 2) {

                    // SHOW MONTHS INSTEAD OF YEARS FOR LESS THAN 2 
        ...
        public Object ConvertBack (Object value, Type targetType, object parameter, System.Globalization.CultureInfo culture) {
            ...
            throw new ArgumentException ("DateToAgeInYearsString.ConvertBack not implemented.");
