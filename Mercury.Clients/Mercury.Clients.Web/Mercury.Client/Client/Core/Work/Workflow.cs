...
namespace Mercury.Client.Core.Work {
    ...
    public class Workflow : CoreConfigurationObject {
        ...
        private List<Server.Application.WorkflowPermission> permissions = new List<Server.Application.WorkflowPermission> ();
        ...
        public List<Server.Application.WorkflowPermission> Permissions { get { return permissions; } set { permissions = value; } }
