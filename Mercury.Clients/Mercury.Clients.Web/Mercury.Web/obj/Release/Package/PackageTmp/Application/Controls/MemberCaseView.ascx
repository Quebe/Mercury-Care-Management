...
<Telerik:RadGrid ID="MemberCaseGrid" AllowPaging="false" AllowCustomPaging="false" AutoGenerateColumns="false" 
    ...
    <MasterTableView Name="MemberCaseGridMasterView" Width="100%" TableLayout="Auto" DataKeyNames="MemberId, MemberCaseId" CommandItemDisplay="Top" runat="server">
        ...
        <Columns>
            ...
            <Telerik:GridBoundColumn DataField="MemberCaseId" UniqueName="MemberCaseId" HeaderText="Case Id" Visible="false" />
            ...
            <Telerik:GridBoundColumn DataField="MemberCaseIdAnchor" UniqueName="MemberCaseIdAnchor" HeaderText="Case Id" Visible="true" />
            ...
            <Telerik:GridBoundColumn DataField="ResponsibleParty" UniqueName="ResponsibleParty" HeaderText="Responsible Party" ReadOnly="true" Visible="true" />
            
            <Telerik:GridBoundColumn DataField="AssignedTo" UniqueName="AssignedTo" HeaderText="Assigned To" ReadOnly="true" Visible="true" />
            
            
            <Telerik:GridBoundColumn DataField="NextActivity" UniqueName="NextActivity" HeaderText="Next Activity" ReadOnly="true" Visible="true" />
            
            <Telerik:GridBoundColumn DataField="NextActivityDate" UniqueName="NextActivityDate" HeaderText="Activity Date" ReadOnly="true" Visible="true" />
            
            <Telerik:GridBoundColumn DataField="NextThresholdDate" UniqueName="NextThresholdDate" HeaderText="Next Threshold Date" ReadOnly="true" Visible="true" />
        ...
        <DetailTables>
            ...
            <Telerik:GridTableView Width="100%" DataKeyNames="MemberCaseId" runat="server">
                ...
                <ParentTableRelation>
                    ...
                    <Telerik:GridRelationFields MasterKeyField="MemberCaseId" DetailKeyField="MemberCaseId" />
                ...
                <Columns>
                    ...
                    <Telerik:GridBoundColumn DataField="MemberCarePlanId" UniqueName="MemberCaseId" Visible="false" />
                    ...
                    <Telerik:GridBoundColumn DataField="NextObjectiveDate" UniqueName="NextObjectiveDate" HeaderText="Objective Date" ReadOnly="true" Visible="true" />
                    ...
                    <Telerik:GridBoundColumn DataField="NextInterventionDate" UniqueName="NextInterventionDate" HeaderText="Intervention Date" ReadOnly="true" Visible="true" />
