...
<div id="ApplicationTitleBar">
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr class="BackgroundColorDark" style="height: 36px;">
            ...
            <td style="padding-left: .125in; padding-right: .25in"><a class="NoDecoration ColorLight HoverTextWhiteBold" href="javascript:Tour();" style="white-space: nowrap; font-weight: bold; text-align: center;">(close)</a></td>
        ...
        <Telerik:RadSplitter ID="OuterSplitter" Width="100%" Height="100%" BackColor="White" runat="server">
            ...
            <Telerik:RadPane ID="RadPane1" Width="50%" runat="server">
                ...
                <table width="100%" style="height: 100%;">
                    ...
                    <tr style="height: 40px;"><td valign="top">
            
                        <table cellpadding="0" cellspacing="0" style="width: 100%; margin: .125in;"><tr>
                    
                            <td style="height: 32px; width: 40px;"><img src="/Images/Common32/ProblemStatement.png" alt="Problem Statement" /></td>
                    ...
                    <tr style=""><td valign="top" style="padding-left: 10px; padding-right: 10px;">
                        ...
                        <Telerik:RadTreeView ID="ProblemStatementTreeView" Width="100%" Height="100%" CheckBoxes="true" BorderColor="Black" BorderWidth="1" 
                        ...
                        <div style="margin: 0px 10px 2px 10px; padding: 4px; line-height: 150%;">
                            ...
                            <Telerik:RadListView ID="DefaultCarePlanInterventions" runat="server">
                                ...
                                <ItemTemplate>
                                    ...
                                    <li><span style="font-style: italic;"><%# Eval ("CareInterventionName")%></span>: <%# Eval ("CareInterventionDescription")%>
