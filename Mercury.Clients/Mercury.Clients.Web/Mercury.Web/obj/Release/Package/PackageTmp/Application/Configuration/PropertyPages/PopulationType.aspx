<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PopulationType.aspx.cs" Inherits="Mercury.Web.Application.Configuration.PropertyPages.PopulationType" %>
...
<form id="FormPopulationType" runat="server">
            ...
            <Telerik:RadPageView ID="General" runat="server">
                ...
                <table cellpadding="0" cellspacing="0" style="width: 100%; height: 600px;  min-height: 600px;"><tr><td valign="top">
                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 100%; margin: .125in;"><tr>
                        ...
                        <td style="height: 32px; width: 40px;"><img src="/Images/Common32/PopulationType.png" alt="Population Type Properties" /></td>
                        
                        <td style="height: 32px; margin-top: 7px; color: Navy; font-size: 12pt;">General Properties of the Population Type</td>
                    ...
                    <div style="margin: 2px 10px 2px 10px; padding: 4px; line-height: 150%;">
                        ...
                        <div style="position: relative; float: left; width: 75%; padding: 4px;"><Telerik:RadTextBox ID="PopulationTypeName" Width="100%" MaxLength="60" EmptyMessage="(required)" runat="server" /></div>
                    
                    
                        
                        <div style="position: relative; float: left; width: 15%; padding: 4px;">Description:</div>
                    
                        <div style="position: relative; float: left; width: 100%; padding: 4px;"><Telerik:RadTextBox ID="PopulationTypeDescription" Width="98%" Rows="13" TextMode="MultiLine" EmptyMessage="(required)" runat="server" /></div>
                    ...
                    <div style="margin: 2px 10px 2px 10px; padding: 4px; line-height: 150%;">
                        ...
                        <div style="position: relative; float: left; width: 25%">
                            ...
                            <div style="position: relative; float: left; width: 12%; padding: 4px;"><asp:CheckBox ID="PopulationTypeEnabled" runat="server" /></div>
                        ...
                        <div style="position: relative; float: left; width: 25%">
                            ...
                            <div style="position: relative; float: left; width: 12%; padding: 4px;"><asp:CheckBox ID="PopulationTypeVisible" runat="server" /></div>
                    ...
                    <div style="margin: 2px 10px 2px 10px; padding: 4px; line-height: 150%;">
                        ...
                        <div style="position: relative; float: left; width: 50%">
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadTextBox ID="PopulationTypeCreateAuthorityName" Width="100%" TabIndex="-1" ReadOnly="true" runat="server"></Telerik:RadTextBox></div>
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadTextBox ID="PopulationTypeCreateAccountId" Width="100%" TabIndex="-1" ReadOnly="true" runat="server"></Telerik:RadTextBox></div>
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadTextBox ID="PopulationTypeCreateAccountName" Width="100%" TabIndex="-1" ReadOnly="true" runat="server"></Telerik:RadTextBox></div>
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadDateInput ID="PopulationTypeCreateDate" DateFormat="MM/dd/yyyy" Width="100%" TabIndex="-1" ReadOnly="true" runat="server" /></div>
                        ...
                        <div style="position: relative; float: left; width: 50%">
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadTextBox ID="PopulationTypeModifiedAuthorityName" Width="100%" TabIndex="-1" ReadOnly="true" runat="server"></Telerik:RadTextBox></div>
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadTextBox ID="PopulationTypeModifiedAccountId" Width="100%" TabIndex="-1" ReadOnly="true" runat="server"></Telerik:RadTextBox></div>
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadTextBox ID="PopulationTypeModifiedAccountName" Width="100%" TabIndex="-1" ReadOnly="true" runat="server"></Telerik:RadTextBox></div>
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadDateInput ID="PopulationTypeModifiedDate" DateFormat="MM/dd/yyyy" Width="100%" TabIndex="-1" ReadOnly="true" runat="server" /></div>
