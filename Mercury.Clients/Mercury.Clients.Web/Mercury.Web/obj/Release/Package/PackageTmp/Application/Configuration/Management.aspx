        ...
        <Telerik:RadPageView ID="PageCareManagement" runat="server">
            ...
            <Telerik:RadToolBar ID="ToolbarCareManagement" OnClientButtonClicked="TitleToolbar_OnClientButtonClicked" runat="server">
                ...
                <Items>
                    ...
                    <Telerik:RadToolBarButton Text="Add Care <br /> Measurement Scale" Value="AddCareMeasurementScale" ImagePosition="AboveText" ImageUrl="/Images/Common32/CareMeasurementScale.png" />
                    
                    <Telerik:RadToolBarButton Text="Add Care <br /> Measurement" Value="AddCareMeasurement" ImagePosition="AboveText" ImageUrl="/Images/Common32/CareMeasurement.png" />
