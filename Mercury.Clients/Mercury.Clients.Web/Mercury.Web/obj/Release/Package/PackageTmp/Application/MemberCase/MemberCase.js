...
function MemberCase_OnPaint(forEvent) {
    ...
    var splitter = $find("CaseOverviewGridSplitter");
    ...
    // RESIZE OVERVIEW GRID (BY SPLITTER)

    splitter = $find("CaseOverviewGridSplitter");

    // TOP FROM THE FULL WINDOW 
    var splitterTop = document.getElementById("CaseOverviewGridSplitter").offsetTop;

    // MODIFY TOP TO BE RELATIVE TO THE APPLICATION CONTENT CONTROL
    splitterTop = splitterTop - container.offsetTop;

    adjustedHeight = container.offsetHeight - splitterTop - 1 - 69;
