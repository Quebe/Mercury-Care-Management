...
<Telerik:RadTabStrip ID="ClaimHistoryTabStrip" MultiPageID="ClaimHistoryMultipage" SelectedIndex="0" ScrollChildren="true" ScrollButtonsPosition="Right" PerTabScrolling="true" runat="server">
    ...
    <Tabs>
        ...
        <Telerik:RadTab Text="Lab Results"></Telerik:RadTab>
...
<Telerik:RadMultiPage ID="ClaimHistoryMultipage" SelectedIndex="0" runat="server">
                ...
                <DetailTables>
                    ...
                    <Telerik:GridTableView DataKeyNames="ClaimId" AllowPaging="false" BackColor="AliceBlue" BorderColor="Black" BorderStyle="Solid" Width="100%">
                        ...
                        <Columns>
                            ...
                            <Telerik:GridBoundColumn DataField="Line" HeaderText="Line" Visible="true" />
                            ...
                            <Telerik:GridBoundColumn DataField="ServicePlace" HeaderText="POS*" Visible="true" />

                            <Telerik:GridBoundColumn DataField="RevenueCode" HeaderText="Revenue*" Visible="true" />

                            <Telerik:GridBoundColumn DataField="RevenueCodeName" HeaderText="Revenue Description" Visible="false" />

                            <Telerik:GridBoundColumn DataField="ProcedureCode" HeaderText="Procedure*" Visible="true" />

                            <Telerik:GridBoundColumn DataField="ProcedureCodeName" HeaderText="Procedure Code Description" Visible="false" />
    ...
    <Telerik:RadPageView ID="PageLabResult" runat="server">
    
        <Telerik:RadGrid ID="MemberLabResultHistoryGrid" AllowPaging="true" AllowCustomPaging="true" EnableViewState="false" 
        
            OnNeedDataSource="MemberLabResultHistoryGrid_OnNeedDataSource" 
            
            OnPageSizeChanged="MemberLabResultHistoryGrid_OnPageSizeChanged"
            
            AutoGenerateColumns="false" runat="server">

            <MasterTableView Name="MemberLabResultHistoryMasterView" TableLayout="Auto" DataKeyNames="ClaimId">
            
                <Columns>
            
                    <Telerik:GridBoundColumn DataField="LabResultId" HeaderText="Id" Visible="true" />

                    <Telerik:GridBoundColumn DataField="LabReferenceNumber" HeaderText="Reference Number" />

                    <Telerik:GridBoundColumn DataField="MemberId" Visible="false" />

                    <Telerik:GridBoundColumn DataField="ProviderId" Visible="false" />

                    <Telerik:GridBoundColumn DataField="ClaimId" Visible="false" />

                    <Telerik:GridBoundColumn DataField="ServiceDate" HeaderText="Date" Visible="true" />

                    <Telerik:GridBoundColumn DataField="Loinc" HeaderText="LOINC" Visible="true" />
                    
                    <Telerik:GridBoundColumn DataField="LabTestName" HeaderText="Name" Visible="true" />

                    <Telerik:GridBoundColumn DataField="LabValue" HeaderText="Value" Visible="true" />
                    
                    <Telerik:GridBoundColumn DataField="LabUnitType" HeaderText="Unit" Visible="true" />

                    <Telerik:GridBoundColumn DataField="LabResultText" HeaderText="Result" Visible="true" />
