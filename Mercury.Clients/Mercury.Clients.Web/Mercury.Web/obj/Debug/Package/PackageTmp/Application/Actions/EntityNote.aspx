<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EntityNote.aspx.cs" Inherits="Mercury.Web.Application.Actions.EntityNote" %>
...
<%@ Register TagPrefix="MercuryUserControl" TagName="EntityNote" Src="~/Application/Controls/EntityNote.ascx"  %>
...
<div id="NoteMemberContainer" style="overflow: visible; padding: 10px; font-family: segoe ui, arial; font-size: 12px; background-color: white ">

    <div style="font-family: segoe ui, arial; font-size: 12px; padding: 10px; font-weight: bold; overflow: auto;">
    
        Note <asp:Literal ID="EntityTypeDescription" runat="server"></asp:Literal>: <asp:Literal ID="EntityName" runat="server"></asp:Literal>
        
    </div>
                                               
    <Telerik:RadSplitter ID="EntityInfoNoteSplitter" Orientation="Horizontal" BackColor="White" Width="99%" runat="server">
        ...
        <Telerik:RadPane ID="EntityInfoPane" Height="22" Scrolling="None" runat="server">
            ...
            <Telerik:RadSlidingZone ID="EntityInfoSlidingZone" ClickToOpen="true" Height="22" SlideDirection="Bottom" runat="server">
                ...
                <Telerik:RadSlidingPane ID="EntityInfoNoteHistory" Title="Note History" Height="400" runat="server">
                                
                    <div style="width: 100%; font-family: segoe ui, arial; font-size: 12px; overflow: auto;">
                   
                        <MercuryUserControl:EntityNoteHistory ID="EntityNoteHistoryControl" HistoryGridHeight="350" HistoryGridPageSize="20" runat="server" />
        ...
        <Telerik:RadPane ID="EntityNotePane" Height="600" runat="server">
        
            <MercuryUserControl:EntityNote ID="EntityNoteControl" OnNoteCompleted="EntityNoteControl_OnNoteCompeleted" runat="server" />    
