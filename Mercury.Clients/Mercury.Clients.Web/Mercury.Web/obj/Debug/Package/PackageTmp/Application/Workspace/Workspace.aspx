...
<Telerik:RadAjaxManagerProxy ID="AjaxManagerProxy" runat="server">
    ...
    <AjaxSettings>
        ...
        <Telerik:AjaxSetting AjaxControlID="MyAssignedCasesGrid">
        
            <UpdatedControls>
            
                <Telerik:AjaxUpdatedControl ControlID="MyAssignedCasesGridSplitter" LoadingPanelID="AjaxLoadingPanel" />

            </UpdatedControls>

        </Telerik:AjaxSetting>

        <Telerik:AjaxSetting AjaxControlID="MyTeamCasesGrid">
        
            <UpdatedControls>
            
                <Telerik:AjaxUpdatedControl ControlID="MyTeamCasesGridSplitter" LoadingPanelID="AjaxLoadingPanel" />
...
<div id="WorkspaceContent" style="padding: .125in;">
    ...
    <div id="Workspace_MyAssignedWorkContainer" class="BackgroundColorComplementNormal BorderColorDark" style="background-color: White; padding: .125in">
        ...
        <table id="Workspace_MyAssignedWorkContainer_TitleTable" width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 10px;"><tr>
            
            <td>
            
                <Telerik:RadTabStrip ID="MyAssignedWorkTabStrip" Skin="" EnableEmbeddedSkins="False" 

                    MultiPageID="ContentMultiPage" SelectedIndex="0"  CssClass="RadTabStripBasicWhite" BackColor="White"

                    OnClientTabSelected="Workspace_OnPaint"

                    runat="server">
       
                    <Tabs>
            
                        <Telerik:RadTab Text="My Assigned Work" Selected="True" SelectedCssClass="RadTabStripBasicSelected"></Telerik:RadTab>
                
                        <Telerik:RadTab Text="My Assigned Cases" SelectedCssClass="RadTabStripBasicSelected"></Telerik:RadTab>

                        <Telerik:RadTab Text="My Team Cases" SelectedCssClass="RadTabStripBasicSelected"></Telerik:RadTab>

                        <Telerik:RadTab Text="Case Loads" SelectedCssClass="RadTabStripBasicSelected"></Telerik:RadTab>
            ...
            <Telerik:RadMultiPage ID="ContentMultiPage" SelectedIndex="0" runat="server">
                ...
                <Telerik:RadPageView ID="PageMyAssignedWork" runat="server">
                ...
                <Telerik:RadPageView ID="PageMyAssignedCases" runat="server">
                
                    <Telerik:RadSplitter ID="MyAssignedCasesGridSplitter" Orientation="Horizontal" Width="100%" runat="server">

                        <Telerik:RadPane ID="MyAssignedCasesGridSplitterPane" Scrolling="None" Width="100%" Height="450" runat="server">
                
                            <Telerik:RadGrid ID="MyAssignedCasesGrid" Width="100%" Height="100%"
                                    ...
                                    OnNeedDataSource="MyAssignedCasesGrid_OnNeedDataSource"

                                    OnItemCommand="MyAssignedCasesGrid_OnItemCommand"
                                ...
                                <MasterTableView DataKeyNames="Id">
                                    ...
                                    <Columns>
                                        ...
                                        <Telerik:GridTemplateColumn DataField="Member.Name" HeaderText="Member">
            
                                            <ItemTemplate>
                
                                                <a href="#" onclick="javascript:window.open('/Application/Member/MemberProfile.aspx?MemberId=<%# Eval ("Member.Id")  %>', '_blank', 'location=no,directories=no,menubar=no,toolbar=no,resizable=yes,scrollbars=yes,status=yes')" title="Open Case" alt="Open Case"><%# Eval ("Member.Name")%></a>

                                            </ItemTemplate>
            
                                        </Telerik:GridTemplateColumn>

                                        <Telerik:GridBoundColumn DataField="StatusDescription" HeaderText="Status" Visible="true" />

                                    </Columns>                          
                                
                                    <DetailTables>
                                    
                                        <Telerik:GridTableView DataKeyNames="" AllowFilteringByColumn="false" runat="server">
                ...
                <Telerik:RadPageView ID="PageMyTeamCases" runat="server">
                
                    <Telerik:RadSplitter ID="MyTeamCasesGridSplitter" Orientation="Horizontal" Width="100%" runat="server">

                        <Telerik:RadPane ID="MyTeamCasesGridSplitterPane" Scrolling="None" Width="100%" Height="450" runat="server">
                
                            <Telerik:RadGrid ID="MyTeamCasesGrid" Width="100%" Height="100%"
                                    ...
                                    OnNeedDataSource="MyTeamCasesGrid_OnNeedDataSource"
                                ...
                                <MasterTableView>
                                    ...
                                    <Columns>
                                        ...
                                        <Telerik:GridBoundColumn DataField="LockedByUserDisplayName" HeaderText="Locked By" Visible="true" />                                        
                ...
                <Telerik:RadPageView ID="PageCaseLoad" runat="server">
                
                    <Telerik:RadSplitter ID="CaseLoadGridSplitter" Orientation="Horizontal" Width="100%" runat="server">

                        <Telerik:RadPane ID="CaseLoadGridSplitterPane" Scrolling="None" Width="100%" Height="450" runat="server">
                
                            <Telerik:RadGrid ID="CaseLoadGrid" Width="100%" Height="100%"
                            
                                    AutoGenerateColumns="false" AllowMultiRowSelection="false" AllowSorting="true" 
            
                                    AllowFilteringByColumn="false"
                                    
                                    OnNeedDataSource="CaseLoadGrid_OnNeedDataSource"

                                    OnItemCommand="CaseLoadGrid_OnItemCommand"
            
                                runat="server">
                            
                                <MasterTableView Name="CaseLoadGridMasterView" DataKeyNames="AssignedToWorkTeamId" ClientDataKeyNames="AssignedToWorkTeamId" IsFilterItemExpanded="false">

                                    <Columns>
                
                                        <Telerik:GridBoundColumn DataField="AssignedToWorkTeamId" Visible="false" />

                                        <Telerik:GridBoundColumn DataField="AssignedToWorkTeamName" HeaderText="Work Team" Visible="true" />

                                        <Telerik:GridBoundColumn DataField="StatusUnderDevelopmentCount" HeaderText="Under Development" Visible="true" />

                                        <Telerik:GridBoundColumn DataField="StatusActiveCount" HeaderText="Active" Visible="true" />

                                        <Telerik:GridBoundColumn DataField="StatusTotalOpenCount" HeaderText="Total Open" Visible="true" />
                                              
                                    </Columns>
                                    
                                    <DetailTables>
                                    
                                        <Telerik:GridTableView AutoGenerateColumns="false" AllowFilteringByColumn="false" runat="server">
                                        
                                            <ParentTableRelation>
                                    
                                                <Telerik:GridRelationFields MasterKeyField="AssignedToWorkTeamId" DetailKeyField="AssignedToWorkTeamId" />

                                            </ParentTableRelation>
                                        
                                            <Columns>
        
                                                <Telerik:GridBoundColumn DataField="AssignedToWorkTeamId" Visible="false"></Telerik:GridBoundColumn>
