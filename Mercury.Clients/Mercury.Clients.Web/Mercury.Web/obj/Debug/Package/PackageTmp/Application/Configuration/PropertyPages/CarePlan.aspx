        ...
        <AjaxSettings>
            ...
            <Telerik:AjaxSetting AjaxControlID="CarePlanGoalsGrid">
                ...
                <UpdatedControls>
                    ...
                    <Telerik:AjaxUpdatedControl ControlID="CarePlanGoalInclusion" LoadingPanelID="AjaxLoadingPanelWhiteout" />
                    ...
                    <Telerik:AjaxUpdatedControl ControlID="CarePlanGoalCareMeasureSelection" LoadingPanelID="AjaxLoadingPanelWhiteout" />
                    ...
                    <Telerik:AjaxUpdatedControl ControlID="CarePlanGoalsGridSplitter" LoadingPanelID="AjaxLoadingPanel" />
                   
                    <Telerik:AjaxUpdatedControl ControlID="CarePlanCareInterventionGoalSelection" LoadingPanelID="AjaxLoadingPanelWhiteout" />
            ...
            <Telerik:AjaxSetting AjaxControlID="InterventionsGrid">
            
                <UpdatedControls>
                
                    <Telerik:AjaxUpdatedControl ControlID="ButtonUpdateIntervention" LoadingPanelID="AjaxLoadingPanelWhiteout" />
                    
                    <Telerik:AjaxUpdatedControl ControlID="ButtonAddIntervention" LoadingPanelID="AjaxLoadingPanelWhiteout" />
               
                    <Telerik:AjaxUpdatedControl ControlID="InterventionsGridSplitter" LoadingPanelID="AjaxLoadingPanel" />
            ...
            <Telerik:AjaxSetting AjaxControlID="ButtonUpdateIntervention">
            ...
            <Telerik:AjaxSetting AjaxControlID="ButtonAddIntervention">
...
<div style="min-width: 800px;">
    ...
    <Telerik:RadTabStrip ID="PropertiesTab" MultiPageID="PropertiesContent" SelectedIndex="0" OnClientTabSelected="CarePlan_Body_OnResize" runat="server">
    ...
    <div id="PageContentContainer" style="height: 600px; overflow: auto; border: 1px solid black;">
        ...
        <Telerik:RadMultiPage ID="PropertiesContent" SelectedIndex="0" runat="server">
            ...
            <Telerik:RadPageView ID="PageGoals" runat="server">
                ...
                <table id="PageGoalsContainer" cellpadding="0" cellspacing="0" style="width: 100%; height: 600px;  min-height: 600px; overflow: hidden"><tr><td valign="top">

                    <div id="PageGoalsTitleSection">
                    ...
                    <Telerik:RadSplitter ID="CarePlanGoalsGridSplitter" Orientation="Horizontal" Width="100%" Height="200" runat="server">

                        <Telerik:RadPane ID="CarePlanGoalsGridSplitterPane" Scrolling="None" Width="100%" Height="100%" runat="server">
                
                        <Telerik:RadGrid ID="CarePlanGoalsGrid" Width="100%" Height="100%" AutoGenerateColumns="false" 
                            ...
                            <MasterTableView TableLayout="Auto">
                                ...
                                <Columns>
                                    ...
                                    <Telerik:GridBoundColumn DataField="CareMeasureName" HeaderText="Measure" ReadOnly="true" Visible="true" />
                    ...
                    <div id="PageGoalsPropertiesSection">
                        ...
                        <table width="100%" style="padding: 4px; table-layout: auto;"><tr>
                            ...
                            <td style="width: 100px; white-space: nowrap">Inclusion:</td>

                            <td style="width: 110px; text-align: right;">
                                                
                                <Telerik:RadComboBox ID="CarePlanGoalInclusion" Width="99%" runat="server">
                                    ...
                                    <Items>
                                        ...
                                        <Telerik:RadComboBoxItem Text="Suggested" Value="2" Visible="false" />

                                        <Telerik:RadComboBoxItem Text="Optional" Value="3" Selected="true" />
                        ...
                        <table width="100%" style="padding: 4px;"><tr>
                            ...
                            <td style="width: 14%; text-align: right">Measure:</td>
                        
                            <td style="width: 45%;">
                                                
                                <Telerik:RadComboBox ID="CarePlanGoalCareMeasureSelection" MarkFirstMatch="true" Width="99%" runat="server"></Telerik:RadComboBox>
            ...
            <Telerik:RadPageView ID="PageInterventions" runat="server">
                ...
                <table cellpadding="0" cellspacing="0" style="width: 100%; min-height: 600px; overflow: hidden"><tr><td valign="top">
                    ...
                    <Telerik:RadSplitter ID="InterventionsGridSplitter" Orientation="Horizontal" Width="100%" Height="380"  runat="server">
                        ...
                        <Telerik:RadGrid ID="InterventionsGrid" Width="100%" Height="100%"
                            ...
                            <MasterTableView TableLayout="Fixed">
                                ...
                                <Columns>
                                    ...
                                    <Telerik:GridBoundColumn DataField="CarePlanGoal.Name" HeaderText="Goal" ReadOnly="true" Visible="true" />
                                    ...
                                    <Telerik:GridButtonColumn HeaderStyle-Width="50" ItemStyle-Width="50" CommandName="Edit" ButtonType="LinkButton" ConfirmText="Are you sure you want to edit this intervention?" UniqueName="EditIntervention" Text="Edit" Visible="false" />
                    ...
                    <div id="InterventionPropertiesContent" style="margin: 0px 0px 0px 0px; padding: 0px; line-height: 150%;">
                        ...
                        <div style=" border: solid 0px black">
                            ...
                            <table width="100%" style="padding: 4px;"><tr>
                                ...
                                <td style="width: 85px;">Goal:</td>
                        
                                <td style="">
                                                
                                    <Telerik:RadComboBox ID="CarePlanCareInterventionGoalSelection" MarkFirstMatch="true" Width="99%" runat="server"></Telerik:RadComboBox>
                            ...
                            <table width="100%" style="padding: 4px;"><tr>
                                ...
                                <td style="">
                                    ...
                                    <Telerik:RadComboBox ID="CarePlanCareInterventionSelection" MarkFirstMatch="true" Width="99%" runat="server"></Telerik:RadComboBox>
    ...
    <table id="DialogButtonTable" cellpadding="0" cellspacing="0" style="width: 100%" border="0"><tr>
...
<script type="text/javascript">
    ...
    if (window.addEventListener) { window.addEventListener('resize', CarePlan_Body_OnResize, false); } else { window.attachEvent('onresize', CarePlan_Body_OnResize); }

    if (window.addEventListener) { window.addEventListener('load', CarePlan_Page_Load, false); } else { window.attachEvent('onload', CarePlan_Page_Load); }


    var isCarePlanPainting = false;


    function CarePlan_Page_Load() {

        setTimeout('CarePlan_OnPaint()', 250);

        return;

    }

    function CarePlan_OnPaint(forEvent) {

        if (isCarePlanPainting) { return; }

        isCarePlanPainting = true;

        var pageContentContainer = document.getElementById("PageContentContainer");

        var dialogButtonTable = document.getElementById("DialogButtonTable");

        var contentContainer = document.getElementById("PageGoalsContainer");

        var carePlanGoalsGrid = $find("<%= CarePlanGoalsGrid.ClientID %>");


        if ((contentContainer == null) || (carePlanGoalsGrid == null)) {

            isCarePlanPainting = false;

            setTimeout('CarePlan_OnPaint ()', 100);
        ...
        PageContentContainer.style.height = availableHeight + "px";

        PageGoalsContainer.style.height = availableHeight + "px";
...
//        availableHeight = availableHeight - document.getElementById("CarePlanPropertiesContainer").offsetHeight - marginHeight;
...
//        document.getElementById("CarePlanTreeView").style.height = availableHeight + "px";
...
//        splitter.set_height("100%");
        ...
        availableHeight = windowHeight - 500;

        if (availableHeight < 0) { availableHeight = 0; }


        if ($find("<%= CarePlanGoalsGridSplitter.ClientID %>") != null) {

            $find("<%= CarePlanGoalsGridSplitter.ClientID %>").set_width("100%");

            $find("<%= CarePlanGoalsGridSplitter.ClientID %>").set_height(availableHeight);

        }


        availableHeight = windowHeight - 320;

        if (availableHeight < 0) { availableHeight = 0; }


        if ($find("<%= InterventionsGridSplitter.ClientID %>") != null) {

            $find("<%= InterventionsGridSplitter.ClientID %>").set_width("100%");

            $find("<%= InterventionsGridSplitter.ClientID %>").set_height(availableHeight);
    ...
    function CarePlan_Body_OnResize(forEvent) {

        CarePlan_OnPaint(forEvent);
