<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="AddCarePlanGoalIntervention.aspx.cs" Inherits="Mercury.Web.Application.MemberCase.Actions.AddCarePlanGoalIntervention" %>
...
<div id="AjaxManagerDiv" style="display: none">
    ...
    <Telerik:RadAjaxManager ID="TelerikAjaxManager" runat="server">
        ...
        <AjaxSettings>
            ...
            <Telerik:AjaxSetting AjaxControlID="CareInterventionTreeView">
            
                <UpdatedControls>
                
                    <Telerik:AjaxUpdatedControl ControlID="CareInterventionTreeView" LoadingPanelID="AjaxLoadingPanel" />

                    <Telerik:AjaxUpdatedControl ControlID="CareInterventionPropertiesDiv" LoadingPanelID="AjaxLoadingPanel" />
            ...
            <Telerik:AjaxSetting AjaxControlID="CareInterventionFilter">
            ...
            <Telerik:AjaxSetting AjaxControlID="CareInterventionFilterClear">
    ...
    <div id="ContentContainer" class="BackgroundColorComplementNormal BorderColorDark" style="height: 500px; background-color: White; padding: 0in; overflow: hidden">  
        ...
        <Telerik:RadSplitter ID="OuterSplitter" Width="100%" Height="100%" BackColor="White" runat="server">
            ...
            <Telerik:RadPane ID="RadPane1" Width="50%" runat="server">
                ...
                <table width="100%" style="height: 100%;">
                    ...
                    <tr style=""><td valign="top" style="width: 100%;">
                        ...
                        <table cellpadding="0" cellspacing="0" style="width: 100%; margin: .125in; margin-top: 0px; margin-bottom: 0px;">
                    
                            <tr><td style="height: 32px; margin-top: 7px; color: Navy; font-size: 12pt;">Care Intervention Selection</td></tr>

                        </table>
                        
                        <div style="margin: 0px 4px 0px 4px; padding: 4px; line-height: 150%;">

                            <table width="100%" cellpadding="4"><tr>
                    
                                <td style="width: 70px; padding: 4px; font-weight: bold;">Goal:</td>
                    
                                <td style="padding: 4px;"><asp:Label ID="MemberCaseCarePlanGoalName" runat="server" /></td>

                                </tr><tr>
                    
                                <td style="padding: 4px; font-weight: bold;" valign="top">Clinical Narrative:</td>
                    
                                <td style="padding: 4px;"><asp:Label ID="MemberCaseCarePlanGoalClinicalNarrative" runat="server" /></td>
                            
                                </tr><tr>
                    
                                <td style="padding: 4px; font-weight: bold;" valign="top">Problems:</td>
                    
                                <td style="padding: 4px;">
                                                               
                                    <Telerik:RadListView ID="CarePlanProblemsListView" runat="server">
                        
                                        <ItemTemplate>
                            
                                            <li style="margin: 0px; padding: 0px;"><span style="font-style: italic;"><%# Eval ("ProblemStatementClassificationWithName")%></span></li>
                    ...
                    <tr style=""><td valign="top" style="padding-left: .125in; padding-right: .125in;">
                        ...
                        <table cellpadding="0" cellspacing="0" style="width: 100%;" border="0"><tr>
                            ...
                            <td style=""><Telerik:RadTextBox ID="CareInterventionFilterText"  Width="90%" runat="server" /></td>

                            <td align="center" style="width: 70px;"><asp:Button ID="CareInterventionFilter" Width="60" Text="Filter" OnClick="CareInterventionFilter_OnClick" runat="server" /></td>

                            <td align="right" style="width: 70px;"><asp:Button ID="CareInterventionFilterClear" Width="60" Text="Clear" OnClick="CareInterventionFilterClear_OnClick" runat="server" /></td>
                    ...
                    <tr style=""><td valign="top" style="padding-left: 10px; padding-right: 10px;">
                        ...
                        <Telerik:RadTreeView ID="CareInterventionTreeView" Width="100%" Height="100" CheckBoxes="true" BorderColor="Black" BorderWidth="1" MultipleSelect="true"
                        
                            OnNodeClick="CareInterventionTreeView_OnNodeClick"
            ...
            <Telerik:RadPane ID="RadPane2" Width="50%" runat="server">
                ...
                <div id="CareInterventionPropertiesDiv" style="width: 100%; height: 100%; overflow: auto;" runat="server">

                    <div class="PropertyPageSectionTitle" style="margin-top: 0px;">Selected Care Intervention Properties</div>
                                       
                    <div style="margin: 2px 10px 2px 10px; padding: 4px; line-height: 150%;">

                        <table width="100%" cellpadding="4"><tr>
                    
                            <td style="width: 20%; padding: 4px; font-weight: bold;">Name:</td>
                    
                            <td style="width: 80%; padding: 4px;"><asp:Label ID="CareInterventionName" runat="server" /></td>

                            </tr><tr>
                    
                            <td style="width: 20%; padding: 4px; font-weight: bold;" valign="top">Description:</td>
                    
                            <td style="width: 80%; padding: 4px;"><asp:Label ID="CareInterventionDescription" runat="server" /></td>
                                                                           
                        </tr></table>

                    </div>
                                                 
                    <div class="PropertyPageSectionTitle">Care Plans and Problems</div>
                    
                    <div style="margin: 0px 10px 2px 10px; padding: 4px; line-height: 150%;">

                        <div style="margin-top: 8px;"><b>Associated with Problems:</b></div>
                        
                        <div style="margin: 0px 10px 2px 10px; padding: 4px; line-height: 150%;">
                          
                            <Telerik:RadListView ID="CareInterventionProblemsListView" runat="server">
                    ...
                    <div style="margin: 0px 10px 2px 10px; padding: 4px; line-height: 150%;">
                        ...
                        <div style="margin: 0px 10px 2px 10px; padding: 4px; line-height: 150%;">
                            ...
                            <Telerik:RadListView ID="CareInterventionActivitiesListView" runat="server">
                        
                                <ItemTemplate>
                            
                                    <li><span style="font-weight: bold;"><%# Eval ("Name")%></span>: <%# Eval ("ClinicalNarrative")%>
...
<script type="text/javascript">
    ...
    function Action_OnPaint(forEvent) {
        ...
        var treeView = $find("<%= CareInterventionTreeView.ClientID %>");
        ...
        document.getElementById("CareInterventionTreeView").style.height = availableHeight - 300 + "px";
