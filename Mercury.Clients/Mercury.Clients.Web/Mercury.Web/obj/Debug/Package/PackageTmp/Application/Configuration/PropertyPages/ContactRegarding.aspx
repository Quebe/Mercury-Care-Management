<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactRegarding.aspx.cs" Inherits="Mercury.Web.Application.Configuration.PropertyPages.ContactRegarding" %>
...
<form id="FormContactRegarding" runat="server">
            ...
            <Telerik:RadPageView ID="General" runat="server">
                ...
                <table cellpadding="0" cellspacing="0" style="width: 100%; height: 600px;  min-height: 600px;"><tr><td valign="top">
                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 100%; margin: .125in;"><tr>
                        ...
                        <td style="height: 32px; width: 40px;"><img src="/Images/Common32/Phone.png" alt="Contact Regarding Properties" /></td>
                        
                        <td style="height: 32px; margin-top: 7px; color: Navy; font-size: 12pt;">General Properties of the Contact Regarding</td>
                    ...
                    <div style="margin: 2px 10px 2px 10px; padding: 4px; line-height: 150%;">
                        ...
                        <div style="position: relative; float: left; width: 75%; padding: 4px;"><Telerik:RadTextBox ID="ContactRegardingName" Width="100%" MaxLength="60" EmptyMessage="(required)" runat="server" /></div>
                    
                        <div style="position: relative; float: left; width: 15%; padding: 4px;">Description:</div>
                    
                        <div style="position: relative; float: left; width: 100%; padding: 4px;"><Telerik:RadTextBox ID="ContactRegardingDescription" Width="98%" Rows="13" TextMode="MultiLine" EmptyMessage="(required)" runat="server" /></div>
                    ...
                    <div style="margin: 2px 10px 2px 10px; padding: 4px; line-height: 150%;">
                        ...
                        <div style="position: relative; float: left; width: 25%">
                            ...
                            <div style="position: relative; float: left; width: 12%; padding: 4px;"><asp:CheckBox ID="ContactRegardingEnabled" runat="server" /></div>
                        ...
                        <div style="position: relative; float: left; width: 25%">
                            ...
                            <div style="position: relative; float: left; width: 12%; padding: 4px;"><asp:CheckBox ID="ContactRegardingVisible" runat="server" /></div>
                    ...
                    <div style="margin: 2px 10px 2px 10px; padding: 4px; line-height: 150%;">
                        ...
                        <div style="position: relative; float: left; width: 50%">
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadTextBox ID="ContactRegardingCreateAuthorityName" Width="100%" TabIndex="-1" ReadOnly="true" runat="server"></Telerik:RadTextBox></div>
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadTextBox ID="ContactRegardingCreateAccountId" Width="100%" TabIndex="-1" ReadOnly="true" runat="server"></Telerik:RadTextBox></div>
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadTextBox ID="ContactRegardingCreateAccountName" Width="100%" TabIndex="-1" ReadOnly="true" runat="server"></Telerik:RadTextBox></div>
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadDateInput ID="ContactRegardingCreateDate" DateFormat="MM/dd/yyyy" Width="100%" TabIndex="-1" ReadOnly="true" runat="server" /></div>
                        ...
                        <div style="position: relative; float: left; width: 50%">
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadTextBox ID="ContactRegardingModifiedAuthorityName" Width="100%" TabIndex="-1" ReadOnly="true" runat="server"></Telerik:RadTextBox></div>
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadTextBox ID="ContactRegardingModifiedAccountId" Width="100%" TabIndex="-1" ReadOnly="true" runat="server"></Telerik:RadTextBox></div>
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadTextBox ID="ContactRegardingModifiedAccountName" Width="100%" TabIndex="-1" ReadOnly="true" runat="server"></Telerik:RadTextBox></div>
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadDateInput ID="ContactRegardingModifiedDate" DateFormat="MM/dd/yyyy" Width="100%" TabIndex="-1" ReadOnly="true" runat="server" /></div>
