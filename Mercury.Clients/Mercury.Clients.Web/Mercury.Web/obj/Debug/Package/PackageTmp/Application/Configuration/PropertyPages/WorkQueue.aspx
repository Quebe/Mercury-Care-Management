<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkQueue.aspx.cs" Inherits="Mercury.Web.Application.Configuration.PropertyPages.WorkQueue" %>
            ...
            <Telerik:RadPageView ID="PageTeams" runat="server">
                ...
                <table cellpadding="0" cellspacing="0" style="width: 100%; height: 600px; min-height: 600px; overflow: hidden;"><tr><td valign="top">
                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 100%; margin: .125in;"><tr>
                        ...
                        <td style="height: 32px; width: 40px;"><img src="/Images/Common32/WorkQueueTeams.png" alt="Work Queue Teams" /></td>
                        
                        <td style="height: 32px; margin-top: 7px; color: Navy; font-size: 12pt;">Work Queue Teams and Permissions</td>
                    
                    </tr></table>
                                                       
                    <div class="PropertyPageSectionTitle">Current Work Teams</div>
            
                    <div style="margin: 2px 10px 2px 10px; padding: 4px; line-height: 150%;">
                    
                        <Telerik:RadGrid ID="WorkTeamsGrid" Height="390" AutoGenerateColumns="false" OnDeleteCommand="WorkTeamsGrid_OnDeleteCommand" runat="server">
                    
                            <MasterTableView Width="100%" DataKeyNames="WorkTeamId,WorkTeamName" TableLayout="Auto">
                            
                                <Columns>
                            
                                    <Telerik:GridBoundColumn DataField="WorkTeamId" UniqueName="WorkTeamId" HeaderText="Id" ReadOnly="true" Visible="false" />
                                    
                                    <Telerik:GridBoundColumn DataField="WorkTeamName" UniqueName="WorkTeamName" HeaderText="Work Team Name" ReadOnly="true" Visible="true" />
                                    
                                    <Telerik:GridBoundColumn DataField="Permission" UniqueName="Permission" HeaderText="Permission" ReadOnly="true" Visible="true" />
                                    
                                    <Telerik:GridButtonColumn CommandName="Delete" ButtonType="LinkButton" ConfirmText="Are you sure you want to remove this Work Team?" UniqueName="DeleteEvent" Text="Delete" />
                    ...
                    <div class="PropertyPageSectionTitle">Add Work Team to Work Queue</div>
                    
                    <table cellpadding="0" cellspacing="0" style="margin: .25in;" border="0"><tr>
                        
                        <td style="width: 80px; padding-right: .125in;">Work Team:</td>
                        
                        <td style=""><Telerik:RadComboBox ID="WorkQueueTeamSelection" Width="100%" Sort="Ascending" runat="server"></Telerik:RadComboBox></td>
                        
                        <td style="width: 80px; padding-left: .125in; padding-right: .125in;">Permission:</td>
                        
                        <td style="width: 100px;">
                        
                            <Telerik:RadComboBox ID="WorkQueueTeamPermissionSelection" Width="100%" Sort="Ascending" runat="server">
                            
                                <Items>
                                
                                    <Telerik:RadComboBoxItem Text="Denied" Value="0" />
                                    
                                    <Telerik:RadComboBoxItem Text="View Only" Value="1" />
                                    
                                    <Telerik:RadComboBoxItem Text="Work" Value="2" />
                                    
                                    <Telerik:RadComboBoxItem Text="Self Assign" Value="3" Selected="true" />
                                    
                                    <Telerik:RadComboBoxItem Text="Manage" Value = "4" />
                        ...
                        <td style="padding-left: .25in; padding-right: .25in; text-align: right; width: 100px;"><asp:Button ID="ButtonAddTeam" Text="Add Team" OnClick="ButtonAddTeams_OnClick" Font-Names="segoe ui, arial" Font-Size="11px" Height="24" runat="server" /></td>
            ...
            <Telerik:RadPageView ID="PageExtendedProperties" runat="server">
                ...
                <table cellpadding="0" cellspacing="0" style="width: 100%; height: 600px; min-height: 600px; overflow: hidden;"><tr><td valign="top">
                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 100%; margin: .125in;"><tr>
                        ...
                        <td style="height: 32px; width: 40px;"><img src="/Images/Common32/WorkQueueExtendedProperties.png" alt="Extended Properties" /></td>
