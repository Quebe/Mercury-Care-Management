<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EntitySendCorrespondence.aspx.cs" Inherits="Mercury.Web.Application.Actions.EntitySendCorrespondence" %>
...
<%@ Register TagPrefix="MercuryUserControl" TagName="SendCorrespondenceEntity" Src="~/Application/Controls/EntitySendCorrespondence.ascx"  %>
...
<div id="CorrespondenceEntityContainer" style="overflow: visible; padding: 10px; font-family: segoe ui, arial; font-size: 12px; background-color: white ">

    <div style="font-family: segoe ui, arial; font-size: 12px; padding: 10px; font-weight: bold; overflow: auto;">
    
        Send Correspondence <asp:Literal ID="EntityTypeDescription" runat="server"></asp:Literal>: <asp:Literal ID="EntityName" runat="server"></asp:Literal>
        
    </div>
                                               
    <Telerik:RadSplitter ID="EntityInfoCorrespondenceSplitter" Orientation="Horizontal" Width="99%" runat="server">
        ...
        <Telerik:RadPane ID="EntityInfoPane" Height="22" Scrolling="None" runat="server">
            ...
            <Telerik:RadSlidingZone ID="EntityInfoSlidingZone" ClickToOpen="true" Height="22" SlideDirection="Bottom" runat="server">
                ...
                <Telerik:RadSlidingPane ID="EntityInfoCorrespondenceHistory" Title="Document History" Height="400" runat="server">
                                
                    <div style="width: 100%; font-family: segoe ui, arial; font-size: 12px; overflow: auto;">
                   
                        <MercuryUserControl:EntityDocumentHistory ID="EntityDocumentHistoryControl" HistoryGridHeight="350" HistoryGridPageSize="20" runat="server" />
        ...
        <Telerik:RadPane ID="EntityContactPane" Height="600" runat="server">
        
            <MercuryUserControl:SendCorrespondenceEntity ID="SendCorrespondenceEntityControl" OnSendCorrespondence="SendCorrespondenceEntityControl_OnSendCorrespondence" runat="server" />    
