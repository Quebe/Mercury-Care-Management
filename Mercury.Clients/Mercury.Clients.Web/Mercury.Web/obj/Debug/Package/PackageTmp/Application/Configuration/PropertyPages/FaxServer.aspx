<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FaxServer.aspx.cs" Inherits="Mercury.Web.Application.Configuration.PropertyPages.FaxServer" %>
...
<form id="FormFaxServer" runat="server">
...
<div style="min-width: 800px;">
    ...
    <Telerik:RadTabStrip ID="PropertiesTab" MultiPageID="PropertiesContent" SelectedIndex="0" runat="server">
        ...
        <Tabs>
            ...
            <Telerik:RadTab Text="Fax Service"></Telerik:RadTab>
    ...
    <div style="height: 600px; overflow: auto; border: 1px solid black;">
        ...
        <Telerik:RadMultiPage ID="PropertiesContent" SelectedIndex="0" runat="server">
            ...
            <Telerik:RadPageView ID="General" runat="server">
                ...
                <table cellpadding="0" cellspacing="0" style="width: 100%; height: 600px;  min-height: 600px;"><tr><td valign="top">
                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 100%; margin: .125in;"><tr>
                        ...
                        <td style="height: 32px; width: 40px;"><img src="/Images/Common32/FaxServer.png" alt="Fax Server Properties" /></td>
                        
                        <td style="height: 32px; margin-top: 7px; color: Navy; font-size: 12pt;">General Properties of the Fax Server</td>
                    ...
                    <div style="margin: 2px 10px 2px 10px; padding: 4px; line-height: 150%;">
                        ...
                        <div style="position: relative; float: left; width: 75%; padding: 4px;"><Telerik:RadTextBox ID="FaxServerName" Width="100%" MaxLength="60" EmptyMessage="(required)" runat="server" /></div>
                    
                    
                        
                        <div style="position: relative; float: left; width: 15%; padding: 4px;">Description:</div>
                    
                        <div style="position: relative; float: left; width: 100%; padding: 4px;"><Telerik:RadTextBox ID="FaxServerDescription" Width="98%" Rows="13" TextMode="MultiLine" EmptyMessage="(required)" runat="server" /></div>
                    ...
                    <div style="margin: 2px 10px 2px 10px; padding: 4px; line-height: 150%;">
                        ...
                        <div style="position: relative; float: left; width: 25%">
                            ...
                            <div style="position: relative; float: left; width: 12%; padding: 4px;"><asp:CheckBox ID="FaxServerEnabled" runat="server" /></div>
                        ...
                        <div style="position: relative; float: left; width: 25%">
                            ...
                            <div style="position: relative; float: left; width: 12%; padding: 4px;"><asp:CheckBox ID="FaxServerVisible" runat="server" /></div>
                    ...
                    <div style="margin: 2px 10px 2px 10px; padding: 4px; line-height: 150%;">
                        ...
                        <div style="position: relative; float: left; width: 50%">
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadTextBox ID="FaxServerCreateAuthorityName" Width="100%" TabIndex="-1" ReadOnly="true" runat="server"></Telerik:RadTextBox></div>
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadTextBox ID="FaxServerCreateAccountId" Width="100%" TabIndex="-1" ReadOnly="true" runat="server"></Telerik:RadTextBox></div>
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadTextBox ID="FaxServerCreateAccountName" Width="100%" TabIndex="-1" ReadOnly="true" runat="server"></Telerik:RadTextBox></div>
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadDateInput ID="FaxServerCreateDate" DateFormat="MM/dd/yyyy" Width="100%" TabIndex="-1" ReadOnly="true" runat="server" /></div>
                        ...
                        <div style="position: relative; float: left; width: 50%">
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadTextBox ID="FaxServerModifiedAuthorityName" Width="100%" TabIndex="-1" ReadOnly="true" runat="server"></Telerik:RadTextBox></div>
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadTextBox ID="FaxServerModifiedAccountId" Width="100%" TabIndex="-1" ReadOnly="true" runat="server"></Telerik:RadTextBox></div>
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadTextBox ID="FaxServerModifiedAccountName" Width="100%" TabIndex="-1" ReadOnly="true" runat="server"></Telerik:RadTextBox></div>
                            ...
                            <div style="overflow: hidden;">
                                ...
                                <div style="position: relative; float: left; width: 60%; padding: 4px;"><Telerik:RadDateInput ID="FaxServerModifiedDate" DateFormat="MM/dd/yyyy" Width="100%" TabIndex="-1" ReadOnly="true" runat="server" /></div>
            ...
            <Telerik:RadPageView ID="PageAssembly" runat="server">
                ...
                <table cellpadding="0" cellspacing="0" style="width: 100%; height: 600px; min-height: 600px;"><tr><td valign="top">
                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 100%; margin: .125in;"><tr>
                        ...
                        <td style="height: 32px; width: 40px;"><img src="/Images/Common32/FaxServer.png" alt="Assembly Properties" /></td>
                        
                        <td style="height: 32px; margin-top: 7px; color: Navy; font-size: 12pt;">Assembly Definition for the Fax Server</td>
                    ...
                    <div style="clear: both; margin: 2px 10px 2px 10px; padding: 4px; line-height: 150%;">
                        ...
                        <div style="position: relative; float: left; width: 80%; padding: 4px;"><Telerik:RadTextBox ID="FaxServerAssemblyPath" Width="100%" MaxLength="255" EmptyMessage="(required)" runat="server" /></div>
                    
                        <div style="position: relative; float: left; width: 15%; padding: 4px;">File Name:</div>
                    
                        <div style="position: relative; float: left; width: 80%; padding: 4px;"><Telerik:RadTextBox ID="FaxServerAssemblyName" Width="100%" MaxLength="99" EmptyMessage="(required)" runat="server" /></div>

                        <div style="position: relative; float: left; width: 15%; padding: 4px;">Class:</div>
                    
                        <div style="position: relative; float: left; width: 80%; padding: 4px;"><Telerik:RadTextBox ID="FaxServerAssemblyClassName" Width="100%" MaxLength="99" EmptyMessage="(required)" runat="server" /></div>
            ...
            <Telerik:RadPageView ID="FaxServerConfigurationPage" runat="server">

                <table cellpadding="0" cellspacing="0" style="width: 100%; height: 600px; min-height: 600px;"><tr><td valign="top">
                                
                    <table cellpadding="0" cellspacing="0" style="width: 100%; margin: .125in;"><tr>
                    
                        <td style="height: 32px; width: 40px;"><img src="/Images/Common32/FaxServer.png" alt="Fax Server Configuration" /></td>
                        
                        <td style="height: 32px; margin-top: 7px; color: Navy; font-size: 12pt;">Fax Server Configuration</td>
                    
                    </tr></table>
                                                       
                    <div class="PropertyPageSectionTitle">Fax Server</div>
                                         
                    <div style="clear: both; margin: 2px 10px 2px 10px; padding: 4px; line-height: 150%;">
                    
                        <div style="position: relative; float: left; width: 15%; padding: 4px;">URL:</div>
                    
                        <div style="position: relative; float: left; width: 80%; padding: 4px;"><Telerik:RadTextBox ID="FaxServerConfigurationFaxUrl" Width="100%" MaxLength="255" EmptyMessage="(optional)" runat="server" /></div>
                    
                        <div style="position: relative; float: left; width: 15%; padding: 4px;">Fax Queue Name:</div>
                    
                        <div style="position: relative; float: left; width: 80%; padding: 4px;"><Telerik:RadTextBox ID="FaxServerConfigurationFaxQueueName" Width="100%" MaxLength="99" EmptyMessage="(optional)" runat="server" /></div>

                        <div style="position: relative; float: left; width: 15%; padding: 4px;">Sender Email:</div>
                    
                        <div style="position: relative; float: left; width: 80%; padding: 4px;"><Telerik:RadTextBox ID="FaxServerConfigurationSenderEmail" Width="100%" MaxLength="99" EmptyMessage="(optional)" runat="server" /></div>
                        
                    </div>

                    <div style="clear: both;"></div>
                    
                    <div class="PropertyPageSectionTitle">Fax Server Monitor</div>
                                         
                    <div style="clear: both; margin: 2px 10px 2px 10px; padding: 4px; line-height: 150%;">
                    
                        <div style="position: relative; float: left; width: 25%; padding: 4px;">Monitor Interval (seconds):</div>
                    
                        <div style="position: relative; float: left; width: 15%; padding: 4px;">

                            <Telerik:RadNumericTextBox ID="FaxServerConfigurationMonitorInterval" EmptyMessage="(required)" Width="60" MinValue="0" MaxValue="32000" NumberFormat-DecimalDigits="0" NumberFormat-GroupSeparator="" runat="server" />
                        
                        </div>
                        
                        <div style="clear: both;"></div>

                        <div style="position: relative; float: left; width: 25%; padding: 4px;">Monitor Timeout (seconds):</div>
                    
                        <div style="position: relative; float: left; width: 15%; padding: 4px;">

                            <Telerik:RadNumericTextBox ID="FaxServerConfigurationMonitorTimeout" EmptyMessage="(required)" Width="60" MinValue="0" MaxValue="32000" NumberFormat-DecimalDigits="0" NumberFormat-GroupSeparator="" runat="server" />
            ...
            <Telerik:RadPageView ID="FaxServiceConfigurationPage" runat="server">
            
                <table cellpadding="0" cellspacing="0" style="width: 100%; height: 600px;  min-height: 600px;"><tr><td valign="top">

                    <table cellpadding="0" cellspacing="0" style="width: 100%; margin: .125in;"><tr>
                    
                        <td style="height: 32px; width: 40px;"><img src="/Images/Common32/FaxServer.png" alt="Fax Service Configuration Properties" /></td>
                        
                        <td style="height: 32px; margin-top: 7px; color: Navy; font-size: 12pt;">Fax Service Configuration Properties</td>
                    ...
                    <div style="margin: 2px 10px 2px 10px; padding: 4px; line-height: 150%;">
                        ...
                        <div style="position: relative; float: left; width: 40%; padding: 4px;"><Telerik:RadTextBox ID="FaxServerConfigurationServerName" Width="100%" MaxLength="60" EmptyMessage="(optional)" runat="server" /></div>
                    
                        <div style="position: relative; float: left; width: 10%; padding: 4px; text-align: right;">Protocol:</div>
                    
                        <div style="position: relative; float: left; width: 10%; padding: 4px;"><Telerik:RadTextBox ID="FaxServerConfigurationBindingProtocol" Width="60" MaxLength="10" EmptyMessage="(optional)" runat="server" /></div>
                        ...
                        <div style="position: relative; float: left; width: 10%; padding: 4px;">
                            ...
                            <Telerik:RadNumericTextBox ID="FaxServerConfigurationPort" EmptyMessage="(required)" Width="55" MinValue="0" MaxValue="32000" NumberFormat-DecimalDigits="0" NumberFormat-GroupSeparator="" runat="server" />
                        ...
                        <div style="position: relative; float: left; width: 80%; padding: 4px;"><Telerik:RadTextBox ID="FaxServerConfigurationServicePath" Width="100%" MaxLength="60" EmptyMessage="(optional)" runat="server" /></div>

                        <div style="position: relative; float: left; width: 15%; padding: 4px;">Service Name:</div>
                    
                        <div style="position: relative; float: left; width: 80%; padding: 4px;"><Telerik:RadTextBox ID="FaxServerConfigurationServiceName" Width="100%" MaxLength="60" EmptyMessage="(optional)" runat="server" /></div>
                    ...
                    <div style="margin: 2px 10px 2px 10px; padding: 4px; line-height: 150%;">
                        ...
                        <div style="position: relative; float: left; width: 35%; padding: 4px;">
                            ...
                            <Telerik:RadComboBox ID="FaxServerConfigurationBindingTypeSelection" Width="100%" runat="server">
                        ...
                        <div style="position: relative; float: left; width: 10%; padding: 4px;">
                            ...
                            <Telerik:RadNumericTextBox ID="FaxServerConfigurationBindingTimeout" EmptyMessage="(required)" Width="55" MinValue="0" MaxValue="360" NumberFormat-DecimalDigits="0" NumberFormat-GroupSeparator="" runat="server" />
                        ...
                        <div style="position: relative; float: left; width: 75%; padding: 4px;">
                            ...
                            <Telerik:RadComboBox ID="FaxServerConfigurationBindingSecurityMode" Width="100%" runat="server">
                        ...
                        <div style="position: relative; float: left; width: 75%; padding: 4px;">
                            ...
                            <Telerik:RadComboBox ID="FaxServerConfigurationBindingTransportCredential" Width="100%" runat="server">
                        ...
                        <div style="position: relative; float: left; width: 75%; padding: 4px;">
                            ...
                            <Telerik:RadComboBox ID="FaxServerConfigurationBindingMessageCredential" Width="100%" runat="server">
                    ...
                    <div style="margin: 2px 10px 2px 10px; padding: 4px; line-height: 150%;">
                        ...
                        <div style="position: relative; float: left; width: 80%; padding: 4px;"><Telerik:RadTextBox ID="FaxServerConfigurationClientCredentialsDomain" Width="100%" MaxLength="60" EmptyMessage="(optional)" runat="server" /></div>

                        <div style="position: relative; float: left; width: 15%; padding: 4px;">User Name:</div>
                    
                        <div style="position: relative; float: left; width: 80%; padding: 4px;"><Telerik:RadTextBox ID="FaxServerConfigurationClientCredentialsUserName" Width="100%" MaxLength="60" EmptyMessage="(optional)" runat="server" /></div>
                    
                        <div style="position: relative; float: left; width: 15%; padding: 4px;">Password:</div>
                    
                        <div style="position: relative; float: left; width: 80%; padding: 4px;"><Telerik:RadTextBox ID="FaxServerConfigurationClientCredentialsPassword" Width="100%" MaxLength="60" EmptyMessage="(optional)" TextMode="Password" runat="server" /></div>
                        ...
                        <div style="position: relative; float: left; width: 80%; padding: 4px;">
                            ...
                            <Telerik:RadComboBox ID="FaxServerConfigurationClientCredentialsImpersonation" Width="100%" runat="server">
