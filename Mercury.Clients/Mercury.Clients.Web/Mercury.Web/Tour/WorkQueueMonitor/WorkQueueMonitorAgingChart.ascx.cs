...
namespace Mercury.Web.Tour.WorkQueueMonitor {
    ...
    public partial class WorkQueueMonitorAgingChart : System.Web.UI.UserControl, ITourControl {

        #region Interface Public Properties

        public Boolean HasPrevious { get { return true; } }

        public Boolean HasNext { get { return false; } }
        ...
        public void TourPrevious_OnClick (Object sender, EventArgs e) {
            ...
            String tourUserControl = "/Tour/WorkQueueMonitor/WorkQueueMonitorSummary.ascx";
            ...
            if (applicationContent != null) {
                ...
                applicationContent = applicationContent.FindControl ("WorkQueueMonitorSummaryGrid");
