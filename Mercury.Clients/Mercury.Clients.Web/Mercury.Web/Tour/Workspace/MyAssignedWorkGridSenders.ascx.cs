...
namespace Mercury.Web.Tour.Workspace {
    public partial class MyAssignedWorkGridSenders : System.Web.UI.UserControl, ITourControl {
        ...
        public void TourNext_OnClick (Object sender, EventArgs e) {
            ...
            String tourUserControl = "/Tour/Workspace/MyAssignedWorkRefresh.ascx";
            ...
            if (applicationContent != null) {
                ...
                applicationContent = applicationContent.FindControl ("MyAssignedWorkRefresh");
