...
namespace Mercury.Web.Tour.Workspace {
    public partial class MyWorkQueuesMonitor : System.Web.UI.UserControl, ITourControl {
        ...
        public void TourNext_OnClick (Object sender, EventArgs e) {
            ...
            String tourUserControl = "/Tour/Workspace/MyWorkQueuesManage.ascx";
            ...
            if (applicationContent != null) {
                ...
                applicationContent = applicationContent.FindControl ("WorkQueueManageLink");
