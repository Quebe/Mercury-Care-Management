...
namespace Mercury.Web.Tour.Workspace {
    ...
    public partial class MyWorkQueuesGetWork : System.Web.UI.UserControl, ITourControl {
        ...
        public void TourPrevious_OnClick (Object sender, EventArgs e) {
            ...
            String tourUserControl = "/Tour/Workspace/MyWorkQueuesCount.ascx";
        ...
        public void TourNext_OnClick (Object sender, EventArgs e) {
            ...
            String tourUserControl = "/Tour/Workspace/MyWorkQueuesMonitor.ascx";
            ...
            if (applicationContent != null) {
                ...
                applicationContent = applicationContent.FindControl ("WorkQueueMonitorLink");
