...
namespace Mercury.Web.Application.Actions {
    public partial class EntityContact : System.Web.UI.Page {
        ...
        protected void Page_Load (object sender, EventArgs e) {
            ...
            if ((!IsPostBack) && (Entity != null)) {
                ...
                ((Web.Application.Controls.EntityContact) ContactEntityControl).Entity = Entity;

                ((Web.Application.Controls.EntityContact)ContactEntityControl).AllowEditRegarding = true;

                ((Web.Application.Controls.EntityContact)ContactEntityControl).RegardingMessage = String.Empty;

                ((Web.Application.Controls.EntityContact)ContactEntityControl).IntroductionScript = String.Empty;
