<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EntityContact.aspx.cs" Inherits="Mercury.Web.Application.Actions.EntityContact" %>
...
<%@ Register TagPrefix="MercuryUserControl" TagName="ContactEntity" Src="~/Application/Controls/EntityContact.ascx"  %>
...
<div id="ContactMemberContainer" style="overflow: visible; padding: 10px; font-family: segoe ui, arial; font-size: 12px; background-color: white ">

    <div style="font-family: segoe ui, arial; font-size: 12px; padding: 10px; font-weight: bold; overflow: auto;">
    
        Contact <asp:Literal ID="EntityTypeDescription" runat="server"></asp:Literal>: <asp:Literal ID="EntityName" runat="server"></asp:Literal>
        
    </div>
                                               
    <Telerik:RadSplitter ID="EntityInfoContactSplitter" Orientation="Horizontal" BackColor="White" Width="99%" runat="server">
        ...
        <Telerik:RadPane ID="EntityInfoPane" Height="22" Scrolling="None" runat="server">
            ...
            <Telerik:RadSlidingZone ID="EntityInfoSlidingZone" ClickToOpen="true" Height="22" SlideDirection="Bottom" runat="server">
                ...
                <Telerik:RadSlidingPane ID="EntityInfoContactHistory" Title="Contact History" Height="400" runat="server">
                                
                    <div style="width: 100%; font-family: segoe ui, arial; font-size: 12px; overflow: auto;">
                   
                        <MercuryUserControl:EntityContactHistory ID="EntityContactHistoryControl" HistoryGridHeight="350" HistoryGridPageSize="20" runat="server" />
        ...
        <Telerik:RadPane ID="EntityContactPane" Height="600" runat="server">
            ...
            <MercuryUserControl:ContactEntity ID="ContactEntityControl" OnContact="ContactEntityControl_OnContact" runat="server" />    
