<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnvironmentDelete.aspx.cs" Inherits="Mercury.Web.Application.Enterprise.Windows.EnvironmentDelete" %>
...
<body>
    ...
    <form id="EnvironmentDelete" runat="server">
    ...
    <div style="width: 300px; vertical-align: middle; text-align: center; overflow: hidden; font-family: Arial; font-size: 10pt; line-height: 150%; text-align: left;">
        ...
        <div>
            ...
            <span style="line-height: 200%; float: right">
                Are you sure that you want to remove this Environment: 
            </span>
        </div>
        ...
        <div style="width: 100%; font-weight: bold">
                <asp:Label ID="UiEnvironmentName" runat="server" Text="No Environment" />
        </div>            
        ...
        <p style="line-height: 200%">
            ** This will not drop the database on the Database Server, and will
            only remove the configuration from the Enterprise Database.    
        </p>
