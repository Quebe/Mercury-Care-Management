...
namespace Mercury.Web.Application.Configuration.PropertyPages {
    ...
    public partial class ServiceSingleton : System.Web.UI.Page {
        ...
        protected void Page_Load (object sender, EventArgs e) {
            ...
            if ((!MercuryApplication.HasEnvironmentPermission (ReviewPermission))
               ...
               && (!MercuryApplication.HasEnvironmentPermission (ManagePermission))) { Response.Redirect ("/PermissionDenied.aspx", true); return; }
        ...
        protected void InitializeGeneralPage () {
            ...
            ServiceSingletonName.Text = serviceSingleton.Name;

            ServiceSingletonDescription.Text = serviceSingleton.Description;

            SingletonClassification.SelectedValue = ((Int32)serviceSingleton.ServiceClassification).ToString ();

            ServiceSingletonEnabled.Checked = serviceSingleton.Enabled;

            ServiceSingletonVisible.Checked = serviceSingleton.Visible;
            ...
            ServiceSingletonCreateAuthorityName.Text = serviceSingleton.CreateAccountInfo.SecurityAuthorityName;

            ServiceSingletonCreateAccountId.Text = serviceSingleton.CreateAccountInfo.UserAccountId;

            ServiceSingletonCreateAccountName.Text = serviceSingleton.CreateAccountInfo.UserAccountName;

            ServiceSingletonCreateDate.MinDate = DateTime.MinValue;

            ServiceSingletonCreateDate.SelectedDate = serviceSingleton.CreateAccountInfo.ActionDate;


            ServiceSingletonModifiedAuthorityName.Text = serviceSingleton.ModifiedAccountInfo.SecurityAuthorityName;

            ServiceSingletonModifiedAccountId.Text = serviceSingleton.ModifiedAccountInfo.UserAccountId;

            ServiceSingletonModifiedAccountName.Text = serviceSingleton.ModifiedAccountInfo.UserAccountName;

            ServiceSingletonModifiedDate.MinDate = DateTime.MinValue;

            ServiceSingletonModifiedDate.SelectedDate = serviceSingleton.ModifiedAccountInfo.ActionDate;
        ...
        protected void InitializeDefinitionGrid () {
            ...
            foreach (Mercury.Client.Core.MedicalServices.Definitions.ServiceSingletonDefinition singletonDefinition in serviceSingleton.Definitions) {
                ...
                definitionTable.Rows.Add (singletonDefinition.Id, Mercury.Server.CommonFunctions.EnumerationToString (singletonDefinition.DataSourceType), singletonDefinition.Criteria ());
        ...
        protected void ApplySecurity () {
            ...
            ServiceSingletonName.ReadOnly = !hasManagePermission;

            ServiceSingletonDescription.ReadOnly = !hasManagePermission;

            ServiceSingletonEnabled.Enabled = hasManagePermission;

            ServiceSingletonVisible.Enabled = hasManagePermission;
            ...
            switch (ServiceTypeSelection.SelectedValue) {
                ...
                case "AllMedical":
                    ...
                    if (hasValue) {
                        ...
                        singletonDefinition.PrincipalDiagnosisVersion = Convert.ToInt32 (CriteriaAllMedicalPrincipalDiagnosisVersion.SelectedValue);

                        singletonDefinition.DiagnosisCriteria = CriteriaAllMedicalDiagnosisCodes.Text;

                        singletonDefinition.DiagnosisVersion = Convert.ToInt32 (CriteriaAllMedicalDiagnosisVersion.SelectedValue);
                ...
                case "Professional":
                    ...
                    if (hasValue) {
                        ...
                        singletonDefinition.PrincipalDiagnosisVersion = Convert.ToInt32 (CriteriaProfessionalPrincipalDiagnosisVersion.SelectedValue);

                        singletonDefinition.DiagnosisCriteria = CriteriaProfessionalDiagnosisCodes.Text;

                        singletonDefinition.DiagnosisVersion = Convert.ToInt32 (CriteriaProfessionalDiagnosisVersion.SelectedValue);
                ...
                case "Institutional":
                    ...
                    if (hasValue) {
                        ...
                        singletonDefinition.PrincipalDiagnosisVersion = Convert.ToInt32 (CriteriaInstitutionalPrincipalDiagnosisVersion.SelectedValue);

                        singletonDefinition.DiagnosisCriteria = CriteriaInstitutionalDiagnosisCodes.Text;

                        singletonDefinition.DiagnosisVersion = Convert.ToInt32 (CriteriaInstitutionalDiagnosisVersion.SelectedValue);
        ...
        protected Boolean ApplyChanges () {
            ...
            serviceSingleton.Name = ServiceSingletonName.Text;

            serviceSingleton.Description = ServiceSingletonDescription.Text;
            ...
            serviceSingleton.Enabled = ServiceSingletonEnabled.Checked;

            serviceSingleton.Visible = ServiceSingletonVisible.Checked;
