                    ...
                    <table cellpadding="0" cellspacing="0" border="0" style="font-weight: normal;"><tr>
                        ...
                        <td>
                            ...
                            <div id="CarePlanGoalEditApplyCancel_<%=this.ClientID %>" style="display: none;">
                                ...
                                <asp:LinkButton ID="CarePlanGoalEditApply" Text="(apply)" OnClick="CarePlanGoalEditApply_OnClick" runat="server"></asp:LinkButton>
        ...
        <div id="CarePlanGoalViewPanel_<%=this.ClientID %>" style="padding: .125in; line-height: 150%; background-color: White; font-weight: normal; display: block;"> 
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="">
                ...
                <tr class="" style="min-height: 24px;">
                    ...
                    <td style="width: 100px; font-weight: bold;">Measure*:</td>

                    <td><asp:Label ID="CarePlanGoalMeasureName" runat="server"></asp:Label></td>

                    <td style="width: 100px; font-weight: bold;">Initial Value:</td>

                    <td style="width: 100px;"><asp:Label ID="CarePlanGoalMeasureInitialValue" runat="server"></asp:Label></td>

                    <td style="width: 100px; font-weight: bold;">Last Value:</td>

                    <td style="width: 100px;"><asp:Label ID="CarePlanGoalMeasureLastValue" runat="server"></asp:Label></td>
                    
                    <td style="width: 100px; font-weight: bold;">Target Value:</td>

                    <td style="width: 100px;"><asp:Label ID="CarePlanGoalMeasureTargetValue" runat="server"></asp:Label></td>
            ...
            <Telerik:RadGrid ID="CarePlanGoalInterventionsGrid" 
        
                    OnItemCreated="CarePlanGoalInterventionsGrid_OnItemCreated"

                    OnNeedDataSource="CarePlanGoalInterventionsGrid_OnNeedDataSource"
                ...
                <MasterTableView CommandItemDisplay="Bottom" DataKeyNames="Id">
                    ...
                    <Columns>
                        ...
                        <Telerik:GridBoundColumn DataField="CareIntervention.Name" HeaderText="Intervention"></Telerik:GridBoundColumn>

                        <Telerik:GridBoundColumn DataField="CareIntervention.Description" HeaderText="Description"></Telerik:GridBoundColumn>
                    ...
                    <CommandItemTemplate>
                        ...
                        <table cellpadding="0" cellspacing="0" style="margin: .06125in;"><tr>
                                        
                            <td>
                                            
                                <asp:HyperLink ID="CarePlanGoalInterventionsGrid_CareInterventionAdd" runat="server">
                                                
                                    <img style="border: 0px; vertical-align: middle;" alt="" src="../../Images/Common16/CareIntervention.png" />
                                                    
                                    <span style="padding-left: 8px; padding-right: 8px;">Add a new Care Intervention to the Goal</span>
        ...
        <div id="CarePlanGoalEditPanel_<%=this.ClientID %>" style="padding: .125in; line-height: 150%; background-color: White; font-weight: normal; display: none;"> 
            ...
            <div id="CarePlanGoalEditPanel_UnderDevelopment" visible="false" runat="server">
                ...
                <table width="100%" cellpadding="0" cellspacing="2"><tr>
                    ...
                    <td style="width: 14%; text-align: right; font-weight: bold;">Measure:</td>
                        
                    <td style="width: 45%;">
                                                
                        <Telerik:RadComboBox ID="CarePlanGoalCareMeasureSelection" Width="99%" runat="server"></Telerik:RadComboBox>
            ...
            <div id="CarePlanGoalEditPanel_Active" visible="false" runat="server">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="">
                    ...
                    <tr class="" style="min-height: 24px;">
                        ...
                        <td style="font-weight: bold;">Measure:</td>
